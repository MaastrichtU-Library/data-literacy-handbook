...
* a **collection** phase, when data is directly collected or otherwise acquired;
* an **analysis and interpretation** stage, where data is processed in order to gather insights;
* an **archiving** stage when data is appraised to see their relevance in the longer term and where relevant moved to long-term storage solution;
