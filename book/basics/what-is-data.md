...
* newspaper articles; 
* correspondence between authors (letters); 
* archival materials; 
* social media posts; 
* blog posts; 
* manifestos; 
...
* video-recordings of enviroments;
* TV shows;
* TV programs; 
* movies;
* social media posts;
...
* distance between people in a context;
...
* plant biological samples (seed bank, etc.);
* environmental samples (soil, water, air, etc.);
